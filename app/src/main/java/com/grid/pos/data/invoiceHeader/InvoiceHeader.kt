...
data class InvoiceHeader(
    ...
    override fun getName(): String {
        ...
        val transNo = if (invoiceHeadTransNo.isNullOrEmpty()) "$invoiceHeadOrderNo" else if (transactionCode.isNullOrEmpty()) "$invoiceHeadTransNo" else " $transactionCode$invoiceHeadTransNo"
